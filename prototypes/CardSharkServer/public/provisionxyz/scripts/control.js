...
$(document).ready(function() {
	...
	$('#loginSubmit').click(function(event) {
		$.getJSON(serverURL + '/provisionxyz/Login' + '?Callback=?',
		{
	...
	$('#addUser').click(function(event) {
		...
		$('#submitEdit').click(function(event) {
			$.getJSON(serverURL + '/provisionxyz/AddUser' + '?Callback=?',
			{
				userID: userID
			},
			function(data, status, jqXHR) {
	...
	$('#codeSubmit').click(function(event) {
		$.getJSON(serverURL + '/provisionxyz/SubmitCode' + '?Callback=?',
		{
			userID:		userID,
...
function loadTable() {
	$.getJSON(serverURL + '/provisionxyz/GetUsers' + '?Callback=?',
	{
		userID: userID
	},
	function(data, status, jqXHR) {
...
function editUser(scope, event, user) {
	...
	$('#submitEdit').click(function(event) {
		...
		$.getJSON(serverURL + '/provisionxyz/UpdateUser' + '?Callback=?',
		{
			userID			:userID,
